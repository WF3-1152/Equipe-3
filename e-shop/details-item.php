		...
		<div class="container">
			...
			<?php else:?>
				...
				<div class="col-6">
					    ...
					    <img class="img-zoom" src="<?=$article['images'];?>">
                ...
                <div class="col-4">
                    ...
                    <a class="btn btn-warning form-control d-block mt-4" href="read-item.php?itemId=<?php echo $article['id'];?>">Ajouter au panier <i class="fas fa-shopping-cart"></i></a>
