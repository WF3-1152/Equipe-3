            ...
            <div class="col-md-6 offer"> <!-- Col-md-6 Begin -->
                ...
                <ul class="menu"> <!-- Menu Begin -->
                    <li>
                        ...
                        <a href="deconnexion.php">Mon Panier</a>
                    </li>
                    <li>
...
<nav class="navbar navbar-expand-lg navbar-warning bg-warning py-3">
    <div class="container d-flex justify-content-around">
        <a class="text-dark text-decoration-none" href="add-item.php">Ajouter</a>
        <a class="text-dark text-decoration-none" href="list-item.php">Liste</a>
    </div>
</nav>