		...
		<div class="container">
			...
			<?php foreach($mes_articles as $mon_article):?>
				<div class="row mb-3 align-items-center">
					<div class="col-2">
						<img style="width: 180px; height: auto;" src="../assets/<?php echo $mon_article['images'];?>" alt="1">
					</div>
					<div class="col-6">
					...
					<div class="col-4 d-flex justify-content-between align-items-center">
						<a class="btn btn-warning" href="admin-details.php?id=<?php echo $mon_article['id'];?>">Voir détails</a>
